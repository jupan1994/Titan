...
public class TicketMasterAPI implements ExternalAPI {
	...
	private static final String API_KEY = "UZWxi0EmFLfn4EZ5bEl1ambeeGTjrVGU";
	...
	public List<Item> search(double lat, double lon, String term) {
		...
		String query = String.format("apikey=%s&geoPoint=%s&keyword=%s&size=60", API_KEY, geoHash, term);
		try {
	...
	// Browser should do it every time you type a url in address bar.
  ...
  // Get first image url from an event object
	...
	// To test result, create a main function to call queryAPI.
